...
class Tests {
    ...
    fun bishopTrajectory() {
        ...
        bishopTrajectory(square("c2"), square("b7")).assertBishopTrajectory(square("c2"), square("b7"), 2)
        bishopTrajectory(square("a4"), square("h7")).assertBishopTrajectory(square("a4"), square("h7"), 2)
    }
